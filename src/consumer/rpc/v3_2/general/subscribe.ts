...
import { ArrayNotEmpty, IsBoolean, IsInt, IsNumber, IsOptional, IsString, Min, ValidateNested } from 'class-validator';
...
export enum KolibriEvent {
    KOLIBRI_WRITE = 'kolibri.write',
    KOLIBRI_COMMIT = 'kolibri.commit',
}
