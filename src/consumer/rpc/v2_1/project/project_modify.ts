...
import { IsBoolean, IsDefined, IsEmpty, IsInt, IsOptional, IsString, Length, ValidateNested } from 'class-validator';
...
export class ProjectModifyParams {
    ...
    @IsEmpty()
    kolibriMinVersion?: number;

    @IsEmpty()
    kolibriMaxVersion?: number;
