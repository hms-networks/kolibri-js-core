...
export class GetHashResponseOpcode extends Opcode {
    constructor() {
        super('getHashResponse', 0x04);
    }

    decode(data: any) {
        let kpo: any = {
            opcode: constants.OPCODE_GETHASH_RESPONSE
        };
        try {
